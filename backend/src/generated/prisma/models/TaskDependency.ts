...
export type TaskDependencyWhereInput = {
  ...
  dependencyType?: Prisma.EnumDependencyTypeFilter<"TaskDependency"> | $Enums.DependencyType
  ...
  dependsOnTask?: Prisma.XOR<Prisma.ClientTaskScalarRelationFilter, Prisma.ClientTaskWhereInput>
}
...
export type TaskDependencyOrderByWithRelationInput = {
  ...
  dependsOnTask?: Prisma.ClientTaskOrderByWithRelationInput
}
...
export type TaskDependencyScalarWhereWithAggregatesInput = {
  ...
  dependencyType?: Prisma.EnumDependencyTypeWithAggregatesFilter<"TaskDependency"> | $Enums.DependencyType
...
export type TaskDependencyCreateInput = {
  ...
  task: Prisma.ClientTaskCreateNestedOneWithoutDependenciesInput
  dependsOnTask: Prisma.ClientTaskCreateNestedOneWithoutDependentOnMeInput
}
...
export type TaskDependencyUpdateInput = {
  ...
  task?: Prisma.ClientTaskUpdateOneRequiredWithoutDependenciesNestedInput
  dependsOnTask?: Prisma.ClientTaskUpdateOneRequiredWithoutDependentOnMeNestedInput
}
...
export type TaskDependencySelect<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetSelect<{
  ...
  dependsOnTask?: boolean | Prisma.ClientTaskDefaultArgs<ExtArgs>
...
export type TaskDependencyOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "taskId" | "dependsOnTaskId" | "dependencyType" | "createdAt", ExtArgs["result"]["taskDependency"]>
...
export type $TaskDependencyPayload<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  objects: {
    ...
    dependsOnTask: Prisma.$ClientTaskPayload<ExtArgs>
  }
...
export interface Prisma__TaskDependencyClient<T, Null = never, ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> extends Prisma.PrismaPromise<T> {
  ...
  dependsOnTask<T extends Prisma.ClientTaskDefaultArgs<ExtArgs> = {}>(args?: Prisma.Subset<T, Prisma.ClientTaskDefaultArgs<ExtArgs>>): Prisma.Prisma__ClientTaskClient<runtime.Types.Result.GetResult<Prisma.$ClientTaskPayload<ExtArgs>, T, "findUniqueOrThrow", GlobalOmitOptions> | Null, Null, ExtArgs, GlobalOmitOptions>
  /**
...
export interface TaskDependencyFieldRefs {
  ...
  readonly dependencyType: Prisma.FieldRef<"TaskDependency", 'DependencyType'>
